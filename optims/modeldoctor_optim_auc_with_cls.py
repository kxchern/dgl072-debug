    ...
    def optimizing(self):
        ...
        for epoch in range(self.args.epochs):
            ...
            if (valid_best < valid_perf) & (self.args.epoch_slice < epoch):
                ...
                if not os.path.exists(self.args.doctor_dict_dir):
                    os.mkdir(self.args.doctor_dict_dir)
                dict_file_path = os.path.join(self.args.doctor_dict_dir, self.args.doctor_identity+'.pth')
