...
class ModelSecondOptLearning_CLS:
    ...
    def optimizing(self):
        ...
        for epoch in range(self.args.epochs):
            ...
            if (valid_best < valid_perf) & (self.args.epoch_slice < epoch):
                ...
                if not os.path.exists(self.args.second_dict_dir):
                    os.mkdir(self.args.second_dict_dir)
                dict_file_path = os.path.join(self.args.second_dict_dir, self.args.second_identity+'.pth')
                torch.save(self.model.state_dict(), dict_file_path)
        
        if not os.path.exists(self.args.second_xlsx_dir):
            os.mkdir(self.args.second_xlsx_dir)
        logs_table.to_excel(os.path.join(self.args.second_xlsx_dir, self.args.second_identity+'.xlsx'))
